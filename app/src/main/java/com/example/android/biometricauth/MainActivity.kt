...
class MainActivity : AppCompatActivity(),
    ...
    private fun showConfirmation(encrypted: ByteArray? = null) {
        if (encrypted != null) {
            ...
            val encryptedText = Base64.encodeToString(encrypted, 0 /* flags */)

            //Storing the SECRET_MESSAGE in Sharedprefrences
            val myPreference = HsPreference(this)
            myPreference.setEncrypted(encryptedText)
            myPreference.setDecrypted(SECRET_MESSAGE)
